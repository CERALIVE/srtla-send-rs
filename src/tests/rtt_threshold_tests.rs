...
mod tests {
    ...
    fn test_prefers_fast_link() {
        ...
        connections[1].rtt.kalman_rtt.update(200.0);
    ...
    fn test_both_fast_picks_better_capacity() {
        ...
        connections[1].rtt.kalman_rtt.update(70.0);
    ...
    fn test_quality_within_fast_links() {
        ...
        connections[1].rtt.kalman_rtt.update(60.0); // Still fast (within delta)
        connections[1].in_flight_packets = 0;
    ...
    fn test_no_rtt_data_treated_as_fast() {
        ...
        connections[0].rtt.kalman_rtt.update(0.0);
        connections[0].in_flight_packets = 5;

        // Connection 1: Has RTT data
        connections[1].rtt.kalman_rtt.update(100.0);
    ...
    fn test_rtt_threshold_with_large_delta() {
        ...
        connections[1].rtt.kalman_rtt.update(150.0);
        connections[1].in_flight_packets = 0; // Best capacity

        connections[2].rtt.kalman_rtt.update(200.0);
    ...
    fn test_time_based_dampening() {
        ...
        connections[1].rtt.kalman_rtt.update(50.0);
        connections[1].in_flight_packets = 0;
